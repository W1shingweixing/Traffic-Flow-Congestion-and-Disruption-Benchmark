...
def main(args):
    ...
    meta_df = pd.read_csv('XTraffic\process\data\sensor_meta_feature.csv', sep='\t')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--incident_path', type=str, default='XTraffic\process\data\incidents_y2023.csv')
